...
{
    public class OpenVRFullConrtollerModel : ControllerModel
    {
        ...
        protected override void XR_InputManager_OnAxis2D(Vector2 value, XR_Enum.Hand hand, XR_Enum.FeatureUsage2DAxis usage2DAxis)
        {
            ...
            {
                case (int)XR_Enum.OpenVRFull_2DAxis.Trackpad:
                    {
                    }
                    break;
            }
        ...
        protected override void XR_InputManager_OnButtonPressed(bool action, XR_Enum.Hand hand, XR_Enum.FeatureUsageButton usageButton)
        {
            ...
            {
                case (int)XR_Enum.OpenVRFull_Button.Primary:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVRFull_Button.Alternate:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVRFull_Button.GripPress:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVRFull_Button.TriggerPress:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVRFull_Button.StickOrPadPress:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVRFull_Button.StickOrPadTouch:
                    {
                    }
                    break;
            }
