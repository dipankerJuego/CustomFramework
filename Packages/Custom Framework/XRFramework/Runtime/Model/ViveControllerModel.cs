...
{
    public class ViveControllerModel : ControllerModel
    {
        protected override void XR_InputManager_OnAxis1D(float value, XR_Enum.Hand hand, XR_Enum.FeatureUsageAxis usageAxis)
        {
            ...
            switch (usageAxisInt)
            {
                case (int)XR_Enum.HTC_Vive_Axis.Trigger:
                    {
                    }
                    break;
                case (int)XR_Enum.HTC_Vive_Axis.Grip:
                    {
                    }
                    break;
                case (int)XR_Enum.HTC_Vive_Axis.CombinedTrigger:
                    {
                    }
                    break;
            }
        ...
        protected override void XR_InputManager_OnAxis2D(Vector2 value, XR_Enum.Hand hand, XR_Enum.FeatureUsage2DAxis usage2DAxis)
        {
            ...
            {
                case (int)XR_Enum.HTC_Vive_2DAxis.Trackpad:
                    {
                    }
                    break;
            }
