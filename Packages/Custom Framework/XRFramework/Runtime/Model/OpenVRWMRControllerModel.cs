...
{
    public class OpenVRWMRControllerModel : ControllerModel
    {
        protected override void XR_InputManager_OnAxis1D(float value, XR_Enum.Hand hand, XR_Enum.FeatureUsageAxis usageAxis)
        {
            ...
            switch (usageAxisInt)
            {
                case (int)XR_Enum.OpenVR_WMR_Axis.Trigger:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_Axis.Grip:
                    {
                    }
                    break;
            }
        ...
        protected override void XR_InputManager_OnAxis2D(Vector2 value, XR_Enum.Hand hand, XR_Enum.FeatureUsage2DAxis usage2DAxis)
        {
            ...
            {
                case (int)XR_Enum.OpenVR_WMR_2DAxis.Joystick:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_2DAxis.Touchpad:
                    {
                    }
                    break;
            }
        ...
        protected override void XR_InputManager_OnButtonPressed(bool action, XR_Enum.Hand hand, XR_Enum.FeatureUsageButton usageButton)
        {
            ...
            {
                case (int)XR_Enum.OpenVR_WMR_Button.Menu:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_Button.Grip:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_Button.TriggerPress:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_Button.TouchpadClick:
                    {
                    }
                    break;
                case (int)XR_Enum.OpenVR_WMR_Button.TouchpadTouch:
                    {
                    }
                    break;
            }
